...
筛选说明:
    成交量超过20日均量1.5倍以上，当日涨幅超过3%，且5日均线在20日均线之上，技术形态良好
...
置信度公式: (vol / vol_ma20 - 1) + (pct_1d * 10) + ((ma5 - ma20) / ma20)

生成时间: 2026-03-11 23:14:59
"""
...
SCREENING_LOGIC = {
    ...
    "confidence_formula": "(vol / vol_ma20 - 1) + (pct_1d * 10) + ((ma5 - ma20) / ma20)",
    "rationale": "成交量超过20日均量1.5倍以上，当日涨幅超过3%，且5日均线在20日均线之上，技术形态良好"
}
# ==================== 筛选逻辑定义结束 ====================
