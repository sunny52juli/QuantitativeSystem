...
筛选说明:
    成交量超过20日均量1.5倍以上，当日涨幅超过3%，且短期均线在长期均线之上，技术形态良好。
...
SCREENING_LOGIC = {
    ...
    "confidence_formula": "(vol / vol_ma20) * (pct_1d) * ((ma5 - ma20) / ma20)",
    "rationale": "成交量超过20日均量1.5倍以上，当日涨幅超过3%，且短期均线在长期均线之上，技术形态良好。"
}
# ==================== 筛选逻辑定义结束 ====================
